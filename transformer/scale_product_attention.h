...
class TORCH_API ScaleProductAttentionImpl
    : public torch::nn::Cloneable<ScaleProductAttentionImpl> {
 public:
  ScaleProductAttentionImpl(double temperature, double att_dropout = 0.1)
      : ScaleProductAttentionImpl(
            ScaleProductAttentionOptions(temperature, att_dropout)) {}
...
/// See the documentation for `ScaleProductAttentionImpl` class to learn what
